...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{knight.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{queen.pdf}
    \caption[rules-queen]{%
        超级皇后对战游戏规则——皇后状态%
      }
    \label{fig:queen}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{super.pdf}
    \caption[rules-super]{%
        超级皇后对战游戏规则——超级状态%
      }
    \label{fig:super}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{rp.pdf}
    \caption[rp]{%
        随机玩家在白色圆点中任选%
      }
    \label{fig:super}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gp1.pdf}
    \caption[gp1]{%
        黑色圆点代表当前黑色超级皇后合法行动%
      }
    \label{fig:gp1}
...
（8）使用Softmax激活函数的全连接层输出维度为动作空间大小（action size）的概率值$p$；
（9）使用双曲正切激活函数（tanh）的全连接层输出维度为1的奖励值（预测胜者）$v$；
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{classic.png}
    \caption[cnn]{%
    经典卷积神经网络%
      }
    \label{fig:cnn}
