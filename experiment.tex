...
\begin{table}[H]
    ...
    \hline
    超级/开局 & RLP2 vs RLP1, 每局用时$\approx$310s & RLP2 vs ABP, 每局用时$\approx$310s & RLP2 vs GP,每局用时$\approx$120s & RLP2 vs RP,每局用时$\approx$120s \\ \hline
    先手 & $59\%$ & $78\%$ & $89\%$ & $99\%$\\ 
    后手 & $53\%$ & $74\%$ & $86\%$ & $99\%$\\ \hline
    \end{tabular}
    \label{table:airesult2}
  \end{table}

深度残差网络在超级皇后规则下取得了较好的结果，说明其学到了更为复杂的超级皇后对战特征，相比于经典卷积神经网络效果更为理想。
